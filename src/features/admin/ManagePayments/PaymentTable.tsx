    ...
    <div className="overflow-x-auto rounded-xl shadow-lg border border-gray-100 bg-white">
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 border-b rounded-t-xl">
        ...
        <div className="flex items-center gap-2">
          <label htmlFor="methodFilter" className="text-sm text-gray-600">Filter by method:</label>
          <select
            id="methodFilter"
            value={filterMethod}
            onChange={(e) => setFilterMethod(e.target.value)}
            className="px-3 py-1 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-blue-400"
          >
