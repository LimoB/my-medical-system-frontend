...
const UserLayout = () => {
    ...
    return (
        <div className="min-h-screen flex bg-gray-100">
            {/* Sidebar */}
            <aside
                className={`bg-teal-700 text-white w-64 flex flex-col transition-transform duration-300 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
            ...
            >
                <div className="p-6">
                    ...
                    <nav className="flex flex-col space-y-4 text-sm">
                        ...
                        <Link to="/user/book-appointment" className="flex items-center gap-2 hover:underline">
                        ...
                        <Link to="/user/notifications" className="flex items-center gap-2 hover:underline relative">
